    ...
    return (
        <section className={classes.aboutMeContainer}>
            ...
            <article className={classes.textContainer}>
                ...
                >
                    Hi! I'm Alex, a computer science graduate with a focus on C#
                    ...
                    improve my skills. Languages I speak: HTML, CSS, Javascript, Angular, React, C#, .NET.
                    I am currently exploring new professional opportunities where I can apply my skills, collaborate
                    effectively, and contribute to impactful solutions. Please feel free to get in touch to discuss
